...
return [
    ...
    [
        ...
        'active' => ['categorias*', 'marcas*', 'productos*', 'catalogo/vitrina*', 'catalogo/importar*'],
        ...
        'children' => [
            ...
            ['label' => 'Importar Excel', 'route' => 'catalogo.importar', 'active' => 'catalogo/importar*', 'permission' => 'productos.crear'],
        ],
    ],
