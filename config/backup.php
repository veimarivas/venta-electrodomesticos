...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                /*
                 * Solo lo que NO se puede recuperar de otra parte.
                 *
                 * El código vuelve del repositorio y las dependencias de
                 * `composer install` / `npm install`; meter todo `base_path()`
                 * metería también `public/assets` (la plantilla Velzon entera)
                 * y `resources/velzon-html` (189 archivos de referencia), y una
                 * copia de cientos de megas al día nadie la conserva 30 días.
                 *
                 * Lo insustituible son las imágenes que sube el usuario
                 * —logos de marcas y fotos de productos— y el `.env`, que por
                 * definición no está versionado y lleva la APP_KEY: sin ella
                 * no se descifran las sesiones ni los tokens.
                 */
                'include' => [
     ...
     */
    /*
     * Solo se avisa de lo que va mal.
     *
     * Un correo cada día diciendo «la copia salió bien» se convierte en ruido
     * que se archiva sin leer, y entonces el día que falle tampoco se lee. Lo
     * que importa es enterarse de que HOY no hay copia — para eso está
     * `UnhealthyBackupWasFound`, que salta cuando la última supera un día.
     */
    'notifications' => [
        'notifications' => [
        ...
        'mail' => [
            // Se configura en el .env: quién se entera de que la copia falló
            // depende de la instalación, no del código.
            'to' => env('BACKUP_NOTIFICATION_MAIL', env('MAIL_FROM_ADDRESS')),
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            // 30 días de copias diarias completas, como pide el plan (§9).
            // A partir de ahí la retención se va abriendo sola: una por
            // semana, luego una por mes y una por año.
