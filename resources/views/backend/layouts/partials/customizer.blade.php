{{--
    Panel de personalización de Velzon (offcanvas de configuración del tema).

    Se incluye SIEMPRE aunque el botón esté oculto: assets/js/app.js enlaza
    listeners a los controles de este panel sin comprobar si existen, y si
    faltan lanza un TypeError que corta la inicialización del layout.

    El botón flotante que lo abre sí es condicional (config velzon.show_customizer),
    para no exponer el selector de tema a los usuarios finales en producción.
--}}

@if (config("velzon.show_customizer"))
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme01">
                                    <span class="d-block w-100 rounded bg-light" style="height:64px"></span>
                                </label>
                            </div>
