...
document.addEventListener('livewire:init', () => {
    ...
    const modales = {
        ...
        'modal-recibir-aparato': 'modalRecibirAparato',
        'modal-diagnostico': 'modalDiagnostico',
        'modal-esperar-repuesto': 'modalEsperarRepuesto',
        'modal-listo': 'modalListo',
        'modal-irreparable': 'modalIrreparable',
        'modal-entregar-reparacion': 'modalEntregarReparacion',
        'modal-cancelar-reparacion': 'modalCancelarReparacion',
        'modal-programar-entrega': 'modalProgramarEntrega',
        'modal-despachar-entrega': 'modalDespacharEntrega',
        'modal-confirmar-entrega': 'modalConfirmarEntrega',
        'modal-fallar-entrega': 'modalFallarEntrega',
        'modal-reprogramar-entrega': 'modalReprogramarEntrega',
